...
- (void).cxx_destruct;	// IMP=0x0000000101bb7acc
- (id)initWithURL:(id)arg1 withOriginPath:(id)arg2 withConfig:(id)arg3;	// IMP=0x0000000101bb7840
- (id)initWithURL:(id)arg1 withAppName:(id)arg2 withError:(id)arg3;	// IMP=0x0000000101bb772c
