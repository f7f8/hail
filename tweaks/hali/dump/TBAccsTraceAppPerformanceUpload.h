...
+ (id)getObjectInternal:(id)arg1;	// IMP=0x0000000101a0a458
+ (id)getObjectData:(id)arg1;	// IMP=0x0000000101a0a2b0
+ (id)getJSON:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000101a0a234
...
- (void).cxx_destruct;	// IMP=0x0000000101a0a9c4
