...
- (void).cxx_destruct;	// IMP=0x0000000101687890
- (void)addExtDataWithKey:(id)arg1 value:(id)arg2;	// IMP=0x000000010168768c
- (id)initWithType:(int)arg1 subType:(int)arg2 data:(id)arg3 hiddenData:(id)arg4 bounds:(struct CGRect)arg5;	// IMP=0x0000000101687454
