...
- (void).cxx_destruct;	// IMP=0x000000010125bfc8
- (id)init;	// IMP=0x000000010125bedc
- (id)initWithData:(id)arg1 filename:(id)arg2 contentType:(id)arg3;	// IMP=0x000000010125bdd0
