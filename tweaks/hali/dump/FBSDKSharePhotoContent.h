...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001012a3ab8
...
- (void).cxx_destruct;	// IMP=0x00000001012a3ff0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001012a3e34
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001012a3d28
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001012a3ac0
- (_Bool)isEqualToSharePhotoContent:(id)arg1;	// IMP=0x00000001012a385c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001012a37cc
