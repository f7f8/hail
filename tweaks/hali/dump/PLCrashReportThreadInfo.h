...
- (void)dealloc;	// IMP=0x000000010122991c
- (id)initWithThreadNumber:(long long)arg1 stackFrames:(id)arg2 crashed:(_Bool)arg3 registers:(id)arg4;	// IMP=0x000000010122985c
