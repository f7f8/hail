...
- (void).cxx_destruct;	// IMP=0x0000000101187540
- (double)getCostTransmissionConsumingTime;	// IMP=0x00000001011870e4
- (double)getConnectionConsumingTime;	// IMP=0x00000001011870a0
