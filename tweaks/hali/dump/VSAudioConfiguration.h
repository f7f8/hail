...
- (void).cxx_destruct;	// IMP=0x0000000101b0196c
- (id)createAssetWriterOptionsUsingSampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x0000000101b0152c
- (id)init;	// IMP=0x0000000101b014b8
