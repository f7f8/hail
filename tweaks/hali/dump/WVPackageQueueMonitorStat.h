...
+ (id)monitorMeasureRange:(id)arg1;	// IMP=0x0000000101bb3c44
+ (id)monitorPoint;	// IMP=0x0000000101bb3c18
...
- (void)reset;	// IMP=0x0000000101bb3e34
- (void)accumulateUpdate:(_Bool)arg1;	// IMP=0x0000000101bb3e04
- (void)accumulateDelete:(_Bool)arg1;	// IMP=0x0000000101bb3dd4
- (void)accumulateClean:(_Bool)arg1;	// IMP=0x0000000101bb3da4
