...
- (void).cxx_destruct;	// IMP=0x00000001013c9194
- (int)cdnQualityStatusModule;	// IMP=0x00000001013c8ec0
- (int)wjasQualityStatusModule;	// IMP=0x00000001013c8dfc
- (id)init;	// IMP=0x00000001013c8cdc
