...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001012a9fc8
...
- (void).cxx_destruct;	// IMP=0x00000001012aa564
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001012aa35c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001012aa230
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001012a9fd0
- (_Bool)isEqualToShareVideoContent:(id)arg1;	// IMP=0x00000001012a9d0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001012a9c7c
