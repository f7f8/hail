...
- (void).cxx_destruct;	// IMP=0x0000000101a88894
- (void)refreshWhenSwitchForeGround;	// IMP=0x0000000101a88700
- (void)refreshWhenSwitchBackGround;	// IMP=0x0000000101a886d8
- (id)init;	// IMP=0x0000000101a88634
