...
- (void).cxx_destruct;	// IMP=0x00000001011ff704
- (id)setContentWithDic:(id)arg1;	// IMP=0x00000001011ff404
- (void)parseAPIValues:(id)arg1 DimeOrArgs:(id)arg2 Key:(id)arg3;	// IMP=0x00000001011ff050
- (id)getSampling;	// IMP=0x00000001011ff040
- (void)setWithSampling:(id)arg1;	// IMP=0x00000001011fefcc
- (id)getArgs:(id)arg1;	// IMP=0x00000001011fef28
- (id)getDimensions:(id)arg1;	// IMP=0x00000001011fee84
- (id)init;	// IMP=0x00000001011fece4
