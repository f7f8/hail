...
@interface AEUGCFloorHScroll2ViewModel : AEBaseTile
{
...
+ (Class)cellClass;	// IMP=0x0000000100da1318
...
- (void).cxx_destruct;	// IMP=0x0000000100da1190
- (double)heightForReferenceWidth:(double)arg1;	// IMP=0x0000000100da0e54
- (id)initWithTileDTO:(id)arg1;	// IMP=0x0000000100da0804
