...
+ (id)createParamContextWithAppKey:(id)arg1 paramDict:(id)arg2 requestType:(long long)arg3;	// IMP=0x00000001015f5044
...
- (void).cxx_destruct;	// IMP=0x00000001015f4c20
- (id)init;	// IMP=0x00000001015f4aa8
