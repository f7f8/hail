...
+ (id)monitorPoint;	// IMP=0x0000000101b5ecb8
...
- (void).cxx_destruct;	// IMP=0x0000000101b5eec0
- (id)initWithURL:(id)arg1 isHTML:(_Bool)arg2 statusCode:(id)arg3 withReferrer:(id)arg4 withBizCode:(id)arg5;	// IMP=0x0000000101b5ece4
