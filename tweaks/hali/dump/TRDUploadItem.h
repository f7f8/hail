...
- (void).cxx_destruct;	// IMP=0x0000000101a06f10
- (id)initForUploadFile:(id)arg1 andMoveFile:(id)arg2 andUserInfo:(id)arg3;	// IMP=0x0000000101a06bc8
- (id)initWith:(id)arg1 andUrl:(id)arg2 andCount:(long long)arg3 andUserInfo:(id)arg4;	// IMP=0x0000000101a06aa4
