...
- (void).cxx_destruct;	// IMP=0x0000000101b55cd4
...
- (id)createButton:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000101b54d48
- (id)initWithFrame:(struct CGRect)arg1 withTarget:(id)arg2;	// IMP=0x0000000101b54950
