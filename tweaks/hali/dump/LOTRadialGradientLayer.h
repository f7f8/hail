...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0000000101cfef14
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000101cff178
- (id)actionForKey:(id)arg1;	// IMP=0x0000000101cff004
