...
@class NSIndexPath, UICollectionView, UICollectionViewLayout, UIColor;

@protocol AEUGCCollectionViewDelegateWaterfallLayout <UICollectionViewDelegate>
...
@optional
- (UIColor *)collectionView:(UICollectionView *)arg1 layout:(UICollectionViewLayout *)arg2 backgroundColorForSectionAt:(unsigned long long)arg3;
