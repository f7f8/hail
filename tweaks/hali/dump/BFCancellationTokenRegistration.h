...
+ (id)registrationWithToken:(id)arg1 delegate:(CDUnknownBlockType)arg2;	// IMP=0x00000001008ca284
...
- (void).cxx_destruct;	// IMP=0x00000001008ca5cc
- (void)throwIfDisposed;	// IMP=0x00000001008ca510
- (void)notifyDelegate;	// IMP=0x00000001008ca47c
- (void)dispose;	// IMP=0x00000001008ca38c
- (id)init;	// IMP=0x00000001008ca318
