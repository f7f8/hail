...
+ (id)toString:(id)arg1;	// IMP=0x00000001012ba58c
...
- (void).cxx_destruct;	// IMP=0x00000001012ba848
- (id)toDict;	// IMP=0x00000001012b9e1c
- (id)toJSON;	// IMP=0x00000001012b9c94
- (id)init;	// IMP=0x00000001012b9b90
