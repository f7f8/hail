...
- (void).cxx_destruct;	// IMP=0x0000000101d0bd28
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000101d0b798
- (id)initWithType:(id)arg1;	// IMP=0x0000000101d0b734
- (void)dealloc;	// IMP=0x0000000101d0b6dc
