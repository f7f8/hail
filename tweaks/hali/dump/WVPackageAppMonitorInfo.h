...
+ (id)monitorMeasureRange:(id)arg1;	// IMP=0x0000000101bb3f0c
+ (id)monitorPoint;	// IMP=0x0000000101bb3ee0
...
- (void).cxx_destruct;	// IMP=0x0000000101bb4434
- (id)errorArg;	// IMP=0x0000000101bb428c
@property(readonly, nonatomic) _Bool hasPublishTime;
- (id)initWithAppName:(id)arg1 withVersion:(id)arg2 withSeq:(unsigned long long)arg3;	// IMP=0x0000000101bb40f8
