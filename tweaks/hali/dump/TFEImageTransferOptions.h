...
+ (int)invalidIntOption;	// IMP=0x00000001010a7d88
...
- (void).cxx_destruct;	// IMP=0x00000001010a8028
- (id)initWithUrl:(id)arg1;	// IMP=0x00000001010a7c1c
- (id)init;	// IMP=0x00000001010a7c0c
- (id)initWithNamespace:(id)arg1 dir:(id)arg2 name:(id)arg3;	// IMP=0x00000001010a78d8
