...
- (void).cxx_destruct;	// IMP=0x0000000101b9881c
- (void)initPropertyInfo:(Class)arg1;	// IMP=0x0000000101b9835c
- (void)initMonitorInfo:(Class)arg1;	// IMP=0x0000000101b9822c
- (id)initWithClass:(Class)arg1;	// IMP=0x0000000101b981b4
