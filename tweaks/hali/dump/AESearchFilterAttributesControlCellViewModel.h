...
@interface AESearchFilterAttributesControlCellViewModel : AESearchFilterCellBaseViewModel
{
    NSString *_controlTitle;	// 8 = 0x8
    UIImage *_rightImage;	// 16 = 0x10
}

+ (id)viewModelWithModel:(id)arg1;	// IMP=0x0000000100cccc00
...
- (void).cxx_destruct;	// IMP=0x0000000100cccddc
