...
- (void).cxx_destruct;	// IMP=0x00000001008d45e8
- (unsigned long long)nextColumnIndexForItem:(long long)arg1 inSection:(long long)arg2;	// IMP=0x00000001008d4320
- (unsigned long long)longestColumnIndexInSection:(long long)arg1;	// IMP=0x00000001008d412c
- (unsigned long long)shortestColumnIndexInSection:(long long)arg1;	// IMP=0x00000001008d3f2c
- (_Bool)shouldInvalidateLayoutForBoundsChange:(struct CGRect)arg1;	// IMP=0x00000001008d3e74
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x00000001008d3a84
- (id)layoutAttributesForSupplementaryViewOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x00000001008d38f4
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000001008d3744
- (struct CGSize)collectionViewContentSize;	// IMP=0x00000001008d35f8
- (void)prepareLayout;	// IMP=0x00000001008d20a8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001008d2050
- (id)init;	// IMP=0x00000001008d1ff8
- (void)commonInit;	// IMP=0x00000001008d1f68
- (double)itemWidthInSectionAtIndex:(long long)arg1;	// IMP=0x00000001008d1a60
- (long long)columnCountForSection:(long long)arg1;	// IMP=0x00000001008d1968
