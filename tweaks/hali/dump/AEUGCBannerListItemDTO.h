...
@interface AEUGCBannerListItemDTO : NSObject
{
    _Bool _online;	// 8 = 0x8
    ...
    NSString *_extendInfo;	// 112 = 0x70
}

+ (id)replacedKeyFromPropertyName;	// IMP=0x0000000100659d4c
...
- (void).cxx_destruct;	// IMP=0x000000010065a128
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100659d40
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100659cc8
