...
- (void).cxx_destruct;	// IMP=0x0000000101095a40
- (id)initWithCachePolicy:(unsigned long long)arg1 connectionTimeout:(int)arg2 timeout:(int)arg3;	// IMP=0x0000000101095838
- (id)initWithCachePolicy:(unsigned long long)arg1;	// IMP=0x000000010109581c
