...
- (void)dealloc;	// IMP=0x000000010122bc84
- (id)initWithModelName:(id)arg1 processorInfo:(id)arg2 processorCount:(unsigned long long)arg3 logicalProcessorCount:(unsigned long long)arg4;	// IMP=0x000000010122bbc4
