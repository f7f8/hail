...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001012a19b4
...
- (void).cxx_destruct;	// IMP=0x00000001012a1f64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001012a1d5c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001012a1c30
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001012a19bc
- (_Bool)isEqualToShareOpenGraphContent:(id)arg1;	// IMP=0x00000001012a16f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001012a1668
