...
@interface AEVenuePlatformCouponFloorViewModel : AEBaseTile
{
...
+ (Class)cellClass;	// IMP=0x000000010043eb60
...
- (void).cxx_destruct;	// IMP=0x000000010043e988
- (double)heightForReferenceWidth:(double)arg1;	// IMP=0x000000010043e710
- (id)initWithTileDTO:(id)arg1;	// IMP=0x000000010043d5f0
