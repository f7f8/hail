...
- (void).cxx_destruct;	// IMP=0x000000010121b7d0
- (_Bool)endWithMeasureName:(id)arg1;	// IMP=0x000000010121b40c
- (void)startWithMeasureName:(id)arg1;	// IMP=0x000000010121b224
- (_Bool)isExpired;	// IMP=0x000000010121ae90
- (id)initWithEventId:(id)arg1 module:(id)arg2 monitorPoint:(id)arg3;	// IMP=0x000000010121ac34
