...
@interface AEProductDetailMobilePromotionTagDTO : NSObject
{
...
+ (_Bool)propertyIsOptional:(id)arg1;	// IMP=0x00000001005af754
...
- (void).cxx_destruct;	// IMP=0x00000001005af854
