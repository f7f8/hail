...
{
    AFURLSessionManager *_manager;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x00000001008b35b8
- (void)URLSession:(id)arg1 downloadTask:(id)arg2 didFinishDownloadingToURL:(id)arg3;	// IMP=0x00000001008b31e8
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000001008b317c
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00000001008b241c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001008b2008
- (void)cleanUpProgressForTask:(id)arg1;	// IMP=0x00000001008b1e3c
- (void)setupProgressForTask:(id)arg1;	// IMP=0x00000001008b13f4
- (id)init;	// IMP=0x00000001008b123c
