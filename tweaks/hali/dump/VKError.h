...
+ (id)errorWithQuery:(id)arg1;	// IMP=0x000000010095cfec
+ (id)errorWithJson:(id)arg1;	// IMP=0x000000010095cd28
+ (id)errorWithCode:(long long)arg1;	// IMP=0x000000010095cce0
...
- (void).cxx_destruct;	// IMP=0x000000010095d7c0
- (id)description;	// IMP=0x000000010095d260
- (void)answerCaptcha:(id)arg1;	// IMP=0x000000010095d108
- (void)notifyAuthorizationFailed;	// IMP=0x000000010096e744
- (void)notifyCaptchaRequired;	// IMP=0x000000010096e6cc
