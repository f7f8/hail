...
@interface APIPH5WebViewProgressView : UIView
{
...
- (void).cxx_destruct;	// IMP=0x00000001010f0528
- (void)setProgress:(float)arg1 animated:(_Bool)arg2;	// IMP=0x00000001010f00fc
- (void)configureViews;	// IMP=0x00000001010eff94
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001010eff3c
