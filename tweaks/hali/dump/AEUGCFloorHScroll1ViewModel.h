...
@interface AEUGCFloorHScroll1ViewModel : AEBaseTile
{
...
+ (Class)cellClass;	// IMP=0x0000000100dbe5e4
...
- (void).cxx_destruct;	// IMP=0x0000000100dbe45c
- (double)heightForReferenceWidth:(double)arg1;	// IMP=0x0000000100dbe120
- (id)initWithTileDTO:(id)arg1;	// IMP=0x0000000100dbdad0
