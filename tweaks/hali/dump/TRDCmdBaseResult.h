...
- (void).cxx_destruct;	// IMP=0x0000000101a35e98
- (void)setResponseData:(id)arg1;	// IMP=0x0000000101a35bd8
- (id)initWithCmd:(id)arg1;	// IMP=0x0000000101a357a8
- (id)initWithConfig:(id)arg1;	// IMP=0x0000000101a35670
