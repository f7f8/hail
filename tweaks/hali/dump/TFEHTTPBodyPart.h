...
- (void).cxx_destruct;	// IMP=0x00000001010a5c48
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001010a59c0
- (_Bool)transitionToNextPhase;	// IMP=0x00000001010a5814
- (long long)readData:(id)arg1 intoBuffer:(char *)arg2 maxLength:(unsigned long long)arg3;	// IMP=0x00000001010a573c
- (long long)read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x00000001010a537c
...
- (id)stringForHeaders;	// IMP=0x00000001010a4e00
- (void)dealloc;	// IMP=0x00000001010a4ba8
- (id)init;	// IMP=0x00000001010a4b30
