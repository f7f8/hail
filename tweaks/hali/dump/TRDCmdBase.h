...
- (void).cxx_destruct;	// IMP=0x0000000101a06a28
- (id)transferToDic;	// IMP=0x0000000101a06514
- (id)mutableCopy;	// IMP=0x0000000101a06344
- (id)initWithJson:(id)arg1;	// IMP=0x0000000101a05f94
